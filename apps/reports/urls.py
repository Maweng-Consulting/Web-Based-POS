...
from apps.reports.views import (daily_and_weekly_sales, general_sales_report,
                                monthly_sales, sales_by_product, reports_home, sales_today)
...
urlpatterns = [
    ...
    path("weekly-and-daily-sales/", daily_and_weekly_sales, name="weekly-and-daily-sales"),
